class ArticleTrending {
  ...
  factory ArticleTrending.fromJson(Map<String, dynamic> json) {
    return ArticleTrending(
      id: json['id'],
      ...
      like: json['like'] ?? false, // ✅ pastikan fallback boolean
