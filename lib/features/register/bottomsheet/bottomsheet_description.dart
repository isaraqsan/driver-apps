...
class BottomSheetPickerWithDescription {
  static Future<IdLabelDesc?> show({
    required BuildContext context,
    required String title,
    required List<IdLabelDesc> items,
    IdLabelDesc? selected,
    double? maxHeight,
  }) async {
    TextEditingController searchController = TextEditingController();
    List<IdLabelDesc> filtered = List.from(items);

    return showModalBottomSheet<IdLabelDesc>(
      context: context,
